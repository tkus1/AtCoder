...
public class PrimitiveMergeSorter implements Sorter {
    ...
    public ArrayList<Long> sort(ArrayList<Long> inputList) {
        ...
        for (int j = 0; j < sortedList.length; j++) {
            sortedArrayList.addLast(sortedList[j]);
        }
    ...
    private long[] mergeSort(long[] inputList){
    ...
    private long[] merge(long[] listA, long[] listB){
    ...
    public static void main (String[] args){
        ...
        PrimitiveMergeSorter primitiveMergeSorter = new PrimitiveMergeSorter();
        ArrayList<Long> sortedList = primitiveMergeSorter.sort(inputList);
